...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($first_name_error_err) && empty($last_name_error) && empty($email_error) && empty($phone_number_error) && empty($address_error) ) {
          $sql = "INSERT INTO `crud` (`first_name`, `last_name`, `email`, `phone_number`, `address`) VALUES ('$firstName', '$lastName', '$email', '$phoneNumber', '$address')";
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header">
                        <h2>MOZILAMO PROJECT CREATE USER</h2>
                    </div>
